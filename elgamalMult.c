...
int main()
{
    ...
    //For message m2
    int mody2 = modulo(g, x, p); // a=2585,b=47
    printf("y= g^x is %d mod %d\n",mody2,p);
    int modc11 = modulo(g, r, p);
    printf("The value of c1 is : %d mod %d\n",modc11,p);
    int modc22 = modulo(mess*modulo(mody2, r, p),1,p);
    printf("The value of c2 is : %d mod %d\n",modc22,p);
    // int c3 = revModulo(modc11, x, p);
    // printf("The value of revModulo is: %d\n",c3);
    // int m2 = modulo(modc22 * c3, 1, p); // decrypted message
    // printf("The value of decrypted message is : %d \n",m2);
    ...
    int c3 = revModulo(c1mult, x, p);
    printf("The value of revModulo is: %d\n",c3);
    int m2 = modulo(c2mult * c3, 1, p); // decrypted message
    printf("The value of decrypted message is : %d \n",m2);
